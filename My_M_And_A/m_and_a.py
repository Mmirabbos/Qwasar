...
order = ['FirstName', 'LastName', 'FullName', 'Age', 'Gender', 'UserName', 'Email', 'City', 'Country']
selected_columns = merged_df[order]

selected_columns.to_excel('merged.xlsx', index=False)